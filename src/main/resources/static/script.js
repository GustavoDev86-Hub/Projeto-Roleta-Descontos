...
const TEMPO_GIRO_MS = 5000; // 5 segundos para simular a animação da roleta

let chancesRestantes = 3;
let dadosUsuario = null;

// Altere as chaves para os valores diretos do prêmio
const TABELA_PREMIOS = {
    3:  { valor: 3,  texto: "Você ganhou R$ 3 de desconto!",  cupom: "AVENIDA3" },
    5:  { valor: 5,  texto: "Você ganhou R$ 5 de desconto!",  cupom: "AVENIDA5" },
    10: { valor: 10, texto: "Você ganhou R$ 10 de desconto!", cupom: "AVENIDA10" },
    20: { valor: 20, texto: "Você ganhou R$ 20 de desconto!", cupom: "AVENIDA20" },
    40: { valor: 40, texto: "Você ganhou R$ 40 de desconto!", cupom: "AVENIDA40" },
    50: { valor: 50, texto: "Você ganhou R$ 50 de desconto!", cupom: "AVENIDA50" }
};
...
function exibirModalPremio(valorPremio) {
    const premio = TABELA_PREMIOS[valorPremio] || {
        texto: `Você ganhou o prêmio #${valorPremio}!`,
        cupom: `CUPOM-${valorPremio}`
    };
